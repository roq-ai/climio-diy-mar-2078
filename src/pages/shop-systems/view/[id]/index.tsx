...
import { getShopSystemById } from 'apiSdk/shop-systems';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Shop System Detail View
          </Text>
          {hasAccess('shop_system', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/shop-systems/edit/${data?.id}`} passHref legacyBehavior>
              <Button
              ...
              {hasAccess('product', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/products/create?shop_system_id=${data?.id}`}>
