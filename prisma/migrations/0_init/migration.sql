...
CREATE TABLE "shop_system" (
    ...
    CONSTRAINT "shop_system_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "product" ADD CONSTRAINT "product_shop_system_id_fkey" FOREIGN KEY ("shop_system_id") REFERENCES "shop_system"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "provision" ADD CONSTRAINT "provision_seller_id_fkey" FOREIGN KEY ("seller_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "shop_system" ADD CONSTRAINT "shop_system_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
